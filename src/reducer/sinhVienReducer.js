import { THEM_SINH_VIEN, SUA_SINH_VIEN, XOA_SINH_VIEN, CHON_SINH_VIEN } from "../constants/sinhVienConstants"
...
const sinhVienReducer = (state = initialState, action) => {
    ...
    case THEM_SINH_VIEN: {
        ...
        localStorage.setItem(
            'dssv', JSON.stringify(danhSachSinhVienNew)
        )
        return { 
            ...state,
